...
def perform_text_transformations_1 (input_text):                                             # create fucntion for text tranformation with 1 inout parameter
    ...
    return output_like_input                                            # fuction return 1 variable

def perform_text_transformations_2 (text):                                               # create fucntion for replacing IZ to IS with 1 inout parameter
    replace_one_iz = re.sub(r'“iz”', '“YYY“', text)                                      # replace the right "iz" to avoid replication in future
    ...
    return replace_all_iz                                                                # fuction return 1 variable

def count_spaces(input_text):                                                       # create function for counting all spaces
    whitespace_count = input_text.count(' ') + input_text.count('\n')               # count all spaces and enters into original text
    return whitespace_count                                                         # fuction return tuple with 1 variables
...
def main_2():       # create our main function for perform_text_transformations function to get input parameter
    ...
    output_like_input = perform_text_transformations_1(input_text)          # save results from our perform_text_transformations_1 function to the parameter
    replace_all_iz = perform_text_transformations_2(output_like_input)      # save results from our perform_text_transformations_2 function with input as a result from perform_text_transformations_1 function to the parameter
    whitespace_count = count_spaces(input_text)                             # save results from our count_spaces function to the parameter
...
if __name__ == "__main__":    # run main clause only if you run this file
